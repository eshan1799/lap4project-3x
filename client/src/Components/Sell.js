        ...
        return(
            <>
             <form onSubmit={this.handleSubmit}>
                 <input type='number' max={this.props.portfolio.find(pos => pos['ticker'] == this.state.ticker) ? this.props.portfolio.find(pos => pos['ticker'] == this.state.ticker)['shares'] : 0} min="0" step="any" onChange={this.handleInput}></input>
