    ...
    render() {
        return(
            <div id="stats">
                ...
                <tbody>
                <tr>
                    <td class="tg-0lax">Latest Price</td>
                    <td class="tg-0lax">{this.props.search.latestPrice}</td>
                    <td class="tg-0lax">Exchange</td>
                    <td class="tg-0lax">{this.props.search.primaryExchange}</td>
                    
                </tr>
                <tr>
                    <td class="tg-0lax">Previous Close</td>
                    <td class="tg-0lax">{this.props.search.previousClose}</td>
                    <td class="tg-0lax">Change</td>
                    <td class="tg-0lax">{this.props.search.change}</td>
                </tr>
                <tr>
                    
                    
                    <td class="tg-0lax">YTD Change</td>
                    <td class="tg-0lax">{(this.props.search.ytdChange * 100).toFixed(2)}</td>
                    <td class="tg-0lax">Change %</td>
                    <td class="tg-0lax">{(this.props.search.changePercent * 100).toFixed(2)}</td>
                </tr>
                <tr>
                    <td class="tg-0lax">52 Week High</td>
                    <td class="tg-0lax">{this.props.search.week52High}</td>
                    <td class="tg-0lax">52 Week Low</td>
                    <td class="tg-0lax">{this.props.search.week52Low}</td>
